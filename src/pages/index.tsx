  ...
  return {
    props: {
      ...
      mostPopularHighlight: {
        ...
        buttonLink: sections?.popularGames?.highlight?.butonLink,
      ...
      upcomingHighlight: {
        ...
        buttonLink: sections?.upcomingGames?.highlight?.butonLink,
      ...
      freeHighlight: {
        ...
        buttonLink: sections?.freeGames?.highlight?.butonLink,
